...
int *increment_or_decrement_size_of_stack(stack *s){
...
int main(){
	...
	if(check==0){
		...
		start->array=increment_or_decrement_size_of_stack(start); // checking the size of tower lower or greater than 10
		temp->array=increment_or_decrement_size_of_stack(temp);// checking the size of tower lower or greater than 10
		final->array=increment_or_decrement_size_of_stack(final);// checking the size of tower lower or greater than 10
